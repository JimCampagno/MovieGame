    ...
    didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [IMDBAPIClient getMovieInfoWithCompletion:^(NSDictionary *movieInfo){
        // code here
    }];
...
- (NSURL *)applicationDocumentsDirectory
{
    ...
    // code uses a directory named "com.Gamesmith.MovieGame" in the application's
    // documents directory.
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory]
        URLByAppendingPathComponent:@"MovieGame.sqlite"];
    NSError *error = nil;
